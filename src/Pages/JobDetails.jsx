...
const JobDetails = () => {
  ...
  if (!job) {
    return <div className="flex items-center justify-center">Loading...</div>; // Show loading state if job is not yet fetched
  }
      ...
      <div className="flex flex-col md:flex-row justify-between">
        ...
        >
          ...
          >
            <div>
              <p className="flex items-center">
                <span className="font-semibold">Salary: </span> {job.minPrice} -{" "}
                {job.maxPrice} {job.salaryType === "Monthly" ? "k" : "LPA"} /{" "}
                {job.salaryType}
              </p>
              <p className="flex items-center">
                <span className="font-semibold">Location:</span>{" "}
