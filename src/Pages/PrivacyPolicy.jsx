...
const PrivacyPolicy = () => {
  return (
    <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4 py-5 bg-[#FAFAFA] my-5 ">
      ...
      <h1 className="text-4xl mt-5 mb-5">Privacy Policy</h1>
      ...
      <br></br>
      <h2 className="text-3xl my-5">Interpretation and Definitions</h2>
      ...
      <h2 className="text-4xl my-5">Collecting and Using Your Personal Data</h2>
      <h3 className="text-3xl my-5">Types of Data Collected</h3>
      <h4 className="text-2xl my-5">Personal Data</h4>
      <p>
      ...
      <h4 className="text-2xl my-5">Usage Data</h4>
      ...
      <br></br>
      <h4 className="text-3xl my-5">Tracking Technologies and Cookies</h4>
      <p>
      ...
      <br></br>
      <h3 className="text-2xl font-bold my-5">Use of Your Personal Data</h3>
      ...
      <h3 className="text-3xl my-5">Retention of Your Personal Data</h3>
      <p>
      ...
      <br></br>
      <h3 className="text-3xl my-5">Transfer of Your Personal Data</h3>
      <p>
      ...
      <br></br>
      <h3 className="text-3xl my-5">Delete Your Personal Data</h3>
      <p>
      ...
      <br></br>
      <h3 className="text-3xl my-5">Disclosure of Your Personal Data</h3>
      <h4 className="text-2xl my-5">Business Transactions</h4>
      <br></br>
      <p>
      ...
      <br></br>
      <h4 className="text-2xl my-5">Law enforcement</h4>
      <br></br>
      <p>
      ...
      <br></br>
      <h4 className="text-2xl my-5">Other legal requirements</h4>
      <p>
      ...
      <ul className="flex  my-4 flex-col justify-start">
        ...
        <li className="flex items-center">
          <GoDotFill className=" text-xs" /> Protect against legal liability
        </li>
      </ul>
      ...
      <br></br>
      <h2 className="text-4xl my-5">{`Children's Privacy`}</h2>
      <p>
      ...
      <br></br>
      <h2 className="text-2xl my-5">Links to Other Websites</h2>
      <p>
      ...
      <br></br>
      <h2 className="text-2xl my-5">Changes to this Privacy Policy</h2>
      <p>
      ...
      <br></br>
      <h2 className="text-2xl my-5">Contact Us</h2>
      <p>
