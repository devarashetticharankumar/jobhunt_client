...
const Banner = ({
  ...
  return (
    <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4 py-4 md:py-20">
      ...
      >
        {`Explore thousands of opportunities across various industries. Whether
        you're looking for a remote position, a tech role, or an entry-level
        job, we've got you covered.`}
      </motion.p>
